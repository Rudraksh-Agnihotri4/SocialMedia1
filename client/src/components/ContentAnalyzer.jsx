    ...
    <main className="layout">
      ...
      <aside className="side">
        ...
        >
          ...
          <div className="dz-hint">PDF / PNG / JPG / JPEG • Max 10MB</div>
        </section>
        ...
        <section className="card">
          <div className="card-title">
            <FileText size={16}/> {files.length > 0 ? 'Selected File' : 'Idle'}
          </div>
          {files.length===0 ? (
        ...
        <section className="card">
          <div className="card-title"><FileText size={16}/>Text </div>
          <div className="paper">
            <pre className="textblock">{extractedText || 'Ready to Extract'}</pre>
          </div>
        </section>
        ...
        <div className=" insights">
          <div className="card big">
            ...
            <div className="panel soft">
              <p className="caption">
                {suggestions?.caption || 'Waiting for analysis to complete'}
              </p>
            </div>
          </div>
          ...
          <div className="card">
            <div className="card-title"><TrendingUp size={16}/> Engagement++</div>
            <div className="tips">
              {suggestions?.tips?.length
                ...
                : <div className="placeholder">Improve with analysis</div>}
            </div>
          </div>
        </div>
      </section>
